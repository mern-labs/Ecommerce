...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      toast.success(userData.role === "admin" ? "Admin Logged in successfully" : "Login successful")
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-pink-50 via-yellow-50 to-red-50 flex items-center justify-center px-4 py-8">
      {/* Main Card */}
      <div
        className={`bg-white shadow-2xl rounded-3xl w-full max-w-md p-8 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
      >
        {/* Logo */}
        ...
        {/* Title */}
        <h2 className="text-3xl font-bold text-center mb-1 bg-linear-to-r from-pink-500 via-red-500 to-pink-600 bg-clip-text text-transparent">
          Welcome Back
        </h2>
          ...
          <div>
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all placeholder:text-gray-400 ${errors.email
              ...
              <div className="absolute inset-y-0 right-3 flex items-center pointer-events-none">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className={`w-5 h-5 transition-colors ${email ? "text-pink-500" : "text-gray-300"
                    }`}
                >
                  <path
                    strokeLinecap="round"
          ...
          <div>
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3.5 pr-12 border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all placeholder:text-gray-400 ${errors.password
                  ? "border-red-500 bg-red-50"
                  : "border-gray-300 bg-white hover:border-pink-300"
                  }`}
                disabled={isLoading}
