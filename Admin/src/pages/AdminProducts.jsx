...
const AdminProducts = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiInstance.put(`/products/${editingProductId}`, formDataToSend, {
        headers: {
  ...
  const handleDeleteConfirm = async () => {
    try {
      ...
      await apiInstance.delete(`/products/${productToDelete._id}`);
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
          ...
          <div className="px-5 lg:px-6 py-4 border-t border-gray-100 flex items-center justify-between">
            <p className="text-sm text-gray-600">
              Showing <span className="font-semibold">1-{filteredProducts.length}</span> of <span className="font-semibold">{filteredProducts.length}</span> products
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 bg-linear-to-r from-pink-500 to-red-500 text-white rounded-lg font-semibold hover:from-pink-600 hover:to-red-600 transition-all shadow-lg"
                >
                  Update Product
                </button>
              </div>
            ...
            <div className="p-6">
              ...
              {productToDelete && (
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    <img
                      src={`${baseURL}/uploads/products/${productToDelete.image}`}
              ...
              <div className="flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-linear-to-r from-red-500 to-red-600 text-white rounded-lg font-semibold hover:from-red-600 hover:to-red-700 transition-all shadow-lg"
                >
                  Delete Product
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 pb-6">
              <button
                onClick={handleClosePreview}
                className="w-full px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-all"
              >
                Close Preview
              </button>
            </div>
