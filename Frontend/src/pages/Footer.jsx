...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-linear-to-br from-slate-950 via-pink-950 to-slate-950 overflow-hidden">
      {/* Animated Background Orbs - All Pink */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-rose-500/10 rounded-full blur-3xl animate-float-delayed"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink-500/5 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12 lg:mb-16">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Link to="/home" className="inline-block group">
              <div className="relative w-fit">
                <img
                  src={logo}
                  alt="Kalamandir Logo"
                  className="relative h-20 lg:h-24 object-contain bg-white/95 p-3 rounded-xl backdrop-blur-sm transform group-hover:scale-105 group-hover:rotate-2 transition-all duration-300"
                />
              </div>
            </Link>
            ...
            <div className="flex items-start gap-4 group">
              <div className="relative shrink-0">
                <div className="relative w-14 h-14 rounded-2xl bg-linear-to-br from-pink-500 to-rose-600 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
            ...
            {/* Social Icons - All Pink */}
            <div className="flex gap-3 pt-2">
              {[
                { name: 'Facebook', url: 'https://facebook.com', gradient: 'from-pink-600 to-rose-500', icon: (
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                )},
                { name: 'Instagram', url: 'https://instagram.com', gradient: 'from-pink-500 to-rose-600', icon: (
                ...
                { name: 'YouTube', url: 'https://youtube.com', gradient: 'from-pink-600 to-rose-500', icon: (
                ...
                >
                  <div className={`relative w-12 h-12 flex items-center justify-center rounded-2xl bg-linear-to-br ${social.gradient} text-white hover:scale-110 transition-all duration-300 animate-float`}>
          ...
          {/* Navigation Columns - All Pink Gradients */}
          {[
            {
              title: 'Shop',
          ...
          {/* Newsletter Column - Pink Theme */}
          <div className="lg:col-span-3 md:col-span-2">
            <div className="relative group/newsletter">
              <div className="relative">
                <h3 className="font-bold text-transparent bg-linear-to-r from-pink-400 via-rose-400 to-pink-400 bg-clip-text text-xl lg:text-2xl mb-2">
                  Join Our Newsletter
                </h3>
                ...
                <form onSubmit={handleSubscribe} className="space-y-3">
                  <div className="relative group/input">
                    <input
                      ...
                      className="relative w-full px-5 py-3.5 bg-slate-900/80 border-2 border-pink-500/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 text-white text-sm lg:text-base placeholder-gray-500 transition-all duration-300 backdrop-blur-sm"
                      required
                    />
                  </div>
                  <button
                    type="submit"
                    className="relative w-full px-6 py-3.5 bg-linear-to-r from-pink-500 via-rose-500 to-pink-500 text-white rounded-xl font-bold hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 overflow-hidden group/btn bg-size-200"
                  >
                    ...
                    <div className="absolute inset-0 bg-linear-to-r from-rose-600 to-pink-600 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                  </button>
                </form>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <div className="group/card cursor-pointer transform hover:scale-110 transition-all duration-300">
                        <div className="relative">
                          <div className="relative bg-white px-4 py-2.5 rounded-lg">
                      ...
                      <div className="group/card cursor-pointer transform hover:scale-110 transition-all duration-300">
                        <div className="relative">
                          <div className="relative bg-white px-4 py-2.5 rounded-lg">
                            <span className="font-black text-pink-600 text-2xl tracking-wider">UPI</span>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="border-t border-pink-500/20 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-3 group/ssl cursor-pointer order-2 sm:order-1">
              <div className="relative">
                <div className="relative w-11 h-11 bg-linear-to-br from-pink-500 to-rose-600 rounded-xl flex items-center justify-center transform group-hover/ssl:scale-110 group-hover/ssl:rotate-6 transition-all duration-300">
            ...
            {/* Copyright - Pink Hover */}
            <p className="text-gray-400 text-xs lg:text-sm text-center order-1 sm:order-2 hover:text-transparent hover:bg-linear-to-r hover:from-pink-400 hover:to-rose-400 hover:bg-clip-text transition-all duration-300 cursor-default">
              © 2026 Sareeora. All Rights Reserved
            </p>
            
            {/* Scroll to Top - Pink */}
            <button
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="relative w-11 h-11 rounded-xl border-2 border-pink-500/40 flex items-center justify-center text-pink-400 transition-all duration-300 order-3 group/scroll overflow-hidden hover:scale-110 hover:border-pink-400"
              aria-label="Scroll to top"
            >
              <div className="absolute inset-0 bg-linear-to-br from-pink-500 to-rose-600 opacity-0 group-hover/scroll:opacity-100 transition-opacity rounded-xl"></div>
