  ...
  return (
    <>
      <div className="w-full bg-white">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-cyan-300 rounded-full opacity-20 blur-3xl -z-10"></div>
                <div className="absolute -top-6 -left-6 w-32 h-32 bg-pink-300 rounded-full opacity-20 blur-2xl -z-10"></div>
              </div>
              <div>
                <h2 
                ...
                <div className="w-20 h-1 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full mb-6"></div>
                <div className="space-y-4 text-lg text-gray-700" style={{ fontFamily: "'Crimson Text', serif" }}>
                  <p className="leading-relaxed">
                    Born from a deep love for Indian textiles and a desire to preserve the dying art of traditional weaving, 
                    our journey began in the heart of India's weaving villages.
                  </p>
                  <p className="leading-relaxed">
                    We witnessed the incredible skill of master weavers creating magic on their looms—each saree a testament 
                    to generations of knowledge passed down through families. Yet, we also saw how modernization threatened 
                    these ancient crafts.
                  </p>
                  <p className="leading-relaxed">
                    That's when we decided to build a bridge—connecting conscious customers with authentic artisans, ensuring 
                    fair wages, preserving cultural heritage, and making exquisite handcrafted sarees accessible to women who 
                    appreciate the beauty of slow fashion.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 lg:py-32 bg-gradient-to-br from-purple-50 via-pink-50 to-fuchsia-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-10">
                {/* Mission */}
                <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border-t-4 border-cyan-600 hover:shadow-2xl transition-shadow duration-300">
                  <div className="text-5xl mb-4" role="img" aria-label="Mission">🎯</div>
                  <h3 
                  ...
                  >
                    To preserve and celebrate India's rich textile heritage by empowering artisan communities, 
                    promoting sustainable fashion, and connecting conscious customers with authentic handcrafted sarees 
                    that carry centuries of tradition and artistry.
                  </p>
                </div>

                {/* Vision */}
                <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border-t-4 border-pink-500 hover:shadow-2xl transition-shadow duration-300">
                  <div className="text-5xl mb-4" role="img" aria-label="Vision">👁️</div>
                  <h3 
                    className="text-2xl lg:text-3xl font-bold mb-4 text-gray-900"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                  ...
                  <p 
                    ...
                    style={{ fontFamily: "'Crimson Text', serif" }}
                  >
                    To become the most trusted platform for authentic handloom sarees, where every purchase 
                    supports artisan livelihoods, keeps traditional crafts alive for future generations, and brings 
                    the timeless beauty of Indian textiles to women worldwide.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                  ...
                  >
                    <div className="text-6xl mb-4" role="img" aria-label={value.label}>{value.emoji}</div>
                    <h3 
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <div className="w-32 h-1 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full mx-auto mb-6"></div>
                <p 
              ...
              <div className="grid sm:grid-cols-3 gap-8">
                {[
                  ...
                  >
                    <div 
                      className="text-5xl font-bold text-cyan-600 mb-2"
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      {stat.number}
                    </div>
                    <p className="text-lg text-gray-700 font-semibold mb-2">{stat.title}</p>
                    <p 
                ...
                {[
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="text-4xl flex-shrink-0" role="img" aria-label={feature.label}>{feature.emoji}</div>
                      <div>
                        <h3 
        ...
        <section className="py-20 lg:py-32 bg-gradient-to-br from-purple-50 via-pink-50 to-fuchsia-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="w-32 h-1 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full mx-auto mb-8"></div>
              <p 
                className="text-xl text-gray-700 leading-relaxed mb-8"
                style={{ fontFamily: "'Crimson Text', serif" }}
              >
                We promise to bring you authentic, handcrafted sarees that honor tradition while embracing contemporary 
                sensibilities. Every purchase supports artisan families, preserves cultural heritage, and promotes 
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
                <p 
                  ...
                  style={{ fontFamily: "'Crimson Text', serif" }}
                >
                  "Each thread woven into our sarees carries the dreams, skills, and heritage of master artisans. 
                  When you choose our sarees, you're not just buying fabric—you're preserving a living tradition 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12 lg:mb-16">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div className="min-w-0 pt-1">
                  <a 
                    href="tel:+919852985299" 
                    className="font-bold text-white text-xl lg:text-2xl tracking-tight mb-0.5 hover:text-pink-400 transition-colors"
                  >
                    9852 9852 99
                  </a>
            ...
            {navigationSections.map((section, sectionIndex) => (
              <div key={section.title} className="lg:col-span-2" style={{ animationDelay: `${sectionIndex * 100}ms` }}>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {paymentMethods.map((method) => (
                          <div 
                            key={method.name}
                            className="group/card cursor-pointer transform hover:scale-110 transition-all duration-300"
                          >
                            <div className="relative">
                              <div className={`absolute inset-0 bg-gradient-to-r ${method.gradient} rounded-lg blur-md opacity-0 group-hover/card:opacity-60 transition-opacity`}></div>
